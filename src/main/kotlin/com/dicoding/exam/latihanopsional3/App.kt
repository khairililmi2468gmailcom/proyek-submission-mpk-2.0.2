...
fun manipulateString(str: String, int: Int): String {
    ...
    val nonDigitString = str.filterNot { it.isDigit() }

    val multipliedNumber = if (digitString.isNotEmpty()) {
        val number = digitString.toInt()
        number * int
    } else {
        int
    }

    return nonDigitString + multipliedNumber
}
